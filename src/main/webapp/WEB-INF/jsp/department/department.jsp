...
<body class="hold-transition sidebar-mini layout-fixed">
 <%-- <jsp:include page="../common/sideContainer.jsp" /> --%>
		...
		<div class="content-wrapper">
			<nav class="navbar navbar-expand-md navbar-light py-0 courseNavbar"
				...
				<a class="navbar-brand mt-1">
					<span  class="navText">
						<Strong><spring:message code="topnav.lable.deptmanagement"></spring:message></Strong>
					</span>					
				</a>
			</nav>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 dbBtns" id="forresponsivebuttons">
								<button class="btn-sm btn-sm-enabled" type="button"
									id="AddDepartment" hidden><spring:message code="btn.add" /></button>

								<button class="btn-sm" type="button" id="ModifyDepartment"
									disabled hidden><spring:message code="btn.modify" /></button>

								<button class="btn-sm" type="button" id="DeleteDepartment"
								...
								<button id="btnImportDepartment"
									class="btn-sm btn-sm-util-enabled" type="button" onclick="openFileSelection('department')">
	...
	<script>
		var departmentId = '<spring:message code="department.label.departmentid"></spring:message>';
		var departmentName = '<spring:message code="department.label.departmentname"></spring:message>';
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/department.js"></script>
